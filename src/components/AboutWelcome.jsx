...
const AboutWelcome = () => {
  return (
    <section className="relative bg-white min-h-[80vh] py-24 px-6 md:px-16 overflow-hidden">
      ...
      <span className="absolute top-20 right-10 w-6 h-6 border-2 border-indigo-500 rotate-12"></span>
      <span className="absolute bottom-24 right-20 w-8 h-8 border-2 border-green-400 rounded-full"></span>
      <span className="absolute bottom-10 left-1/3 w-5 h-5 border-2 border-purple-500 rotate-45"></span>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6 items-start">
        ...
        <div className="md:col-span-1 flex justify-center md:justify-end relative">
          ...
          <span className="absolute -top-6 -right-6 w-4 h-4 border-2 border-orange-400 rotate-45"></span>
          <span className="absolute bottom-10 -left-5 w-3 h-3 border-2 border-indigo-500 rounded-full"></span>
        </div>
      </div>
    </section>
  );
